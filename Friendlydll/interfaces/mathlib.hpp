...
inline float get_delta(float hspeed, float maxspeed, float airaccelerate) noexcept
{
	const float term = (30.f - (airaccelerate * maxspeed / 66.f)) / hspeed;
